...
.controller('LoginCtrl', function($scope, $state, $templateCache, $q, $rootScope) {
	...
	$scope.user.email = "gabit@muevaelvolante.com";
		...
		cordova.plugins.email.isAvailable(
			function (isAvailable) {
				...
				cordova.plugins.email.open({
					to:      'gabit@muevaelvolante.com',
					cc:      'alberto@muevaelvolante.com',
					// bcc:     ['gabit@muevaelvolante.com', 'jane@doe.com'],
					subject: 'Greetings',
					body:    'How are you? Nice greetings from Racenet'
				});
			}
		);
	};
...
.controller('ArticlesCtrl', function($scope, $http) {
	...
	$http.get('http://volvo-racenet.qiupreview.com/en/app/racenet/mobiletest.html').success(function(response) {
		$scope.articlesHtml = response;
	});
})

// $http.get('http://volvo-racenet.qiupreview.com/en/app/racenet/mobiletest.html')
  // // $http.get('http://volvo-racenet.qiupreview.com/en/app/racenet/mobiletest.html')
  //   .success(function(data, status, headers,config){
  //     console.log('data success');
  //     console.log(data); // for browser console
  //     $scope.contentHome = data; // for UI
  //   })
